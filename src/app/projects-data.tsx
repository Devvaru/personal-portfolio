...
const projects: Readonly<Record<string, Readonly<Record<string, string | ReadonlyArray<string>>>>> = {
    project1: {
        ...
        imgs: [`${basePath}/images/pawtrackr-1.jpg`, `${basePath}/images/pawtrackr-2.jpg`, `${basePath}/images/pawtrackr-3.jpg`],
    ...
    project2: {
        ...
        imgs: [`${basePath}/images/photolabs-1.jpg`, `${basePath}/images/photolabs-2.jpg`, `${basePath}/images/photolabs-3.jpg`],
    ...
    project3: {
        ...
        imgs: [`${basePath}/images/resourcewall-1.jpg`, `${basePath}/images/resourcewall-2.jpg`, `${basePath}/images/resourcewall-3.jpg`],
    ...
    project5: {
        ...
        imgs: [`${basePath}/images/etch-a-sketch-1.jpg`, `${basePath}/images/etch-a-sketch-2.jpg`, `${basePath}/images/etch-a-sketch-3.jpg`],
